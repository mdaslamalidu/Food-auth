    ...
    return (
        <div className='w-1/2 mx-auto my-5 bg-gray-400 p-10 rounded'>
            ...
            <form className='text-left' onSubmit={handleSubmit}>
                ...
                <button type="submit" className="lg:w-full text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Submit</button>
            </form>
        </div>
    );
};
